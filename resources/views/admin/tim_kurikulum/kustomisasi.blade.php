...
<body class="font-montserrat bg-cover" style="background-image: url('{{ asset('images/image-7.png') }}');">
    <div class="flex h-screen px-4 py-4 gap-4">
        ...
        {{-- KONTEN --}}
        <main class="flex-1 px-4 h-full flex flex-col overflow-y-auto">
            ...
            <div class="flex items-start justify-between mb-3 shrink-0">
                ...
                <div class="flex flex-col items-end gap-4">
                    ...
                    <a href="/prodi/{{ $prodi->kode_prodi }}" target="_blank"
                        class="h-10 flex items-center gap-2 px-4 py-2 border border-[#3307CC] text-[#3307CC] rounded-xl text-sm hover:bg-purple-50 transition">
                    ...
                    <button type="submit" form="formKustomisasi"
                        class="h-10 flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#0971F7] to-[#3405CC] rounded-xl text-sm text-white shadow hover:opacity-90 transition">
            ...
            <div class="bg-white p-5 shadow-lg border border-gray-300 rounded-2xl">
                <div class="grid grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi_prodi" class="w-full h-28 mt-2 p-3 border rounded-xl text-sm"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <div id="preview-primary" class="w-10 h-10 rounded-lg border"
                                style="background-color: {{ $prodi->kustomisasi?->primary_color ?? '#000000' }}"></div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <div id="preview-secondary" class="w-10 h-10 rounded-lg border"
                                style="background-color: {{ $prodi->kustomisasi?->secondary_color ?? '#000000' }}"></div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <div id="preview-tertiary" class="w-10 h-10 rounded-lg border"
                                style="background-color: {{ $prodi->kustomisasi?->tertiary_color ?? '#000000' }}"></div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3">
                            <div id="preview-quaternary" class="w-10 h-10 rounded-lg border"
                                style="background-color: {{ $prodi->kustomisasi?->quaternary_color ?? '#000000' }}"></div>
            ...
            <form action="{{ route('admin.profil-lulusan.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="judul_lulusan" placeholder="Masukkan nama profil lulusan"
                        class="w-full h-11 px-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3307CC]/20" required>
                </div>
                <div>
    ...
    <div id="modalEditProfil" class="fixed inset-0 bg-black/30 hidden items-center justify-center z-50">
        <div class="bg-white rounded-2xl w-[500px] p-8 relative shadow-xl">
            ...
            <form id="formEditProfil" method="POST">
                ...
                <div class="mb-5">
                    <label class="block text-[#3307CC] font-medium mb-2">Judul</label>
                    <input id="editJudul" type="text" name="judul_lulusan" placeholder="Masukkan nama profil lulusan"
                        class="w-full h-11 px-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3307CC]/20" required>
                </div>
                <div>
                    <label class="block text-[#3307CC] font-medium mb-2">Deskripsi</label>

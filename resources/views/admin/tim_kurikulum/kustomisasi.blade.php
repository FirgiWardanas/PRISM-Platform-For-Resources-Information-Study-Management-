                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="text" id="input-primary" name="primary_color" class="flex-1 border rounded-lg px-3 py-2 text-sm" value="{{ $prodi->kustomisasi?->primary_color ?? '#000000' }}" placeholder="#000000">
                                    <input type="color" id="picker-primary" value="{{ $prodi->kustomisasi?->primary_color ?? '#000000' }}" class="w-10 h-10 border rounded-lg cursor-pointer">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="text" id="input-secondary" name="secondary_color" class="flex-1 border rounded-lg px-3 py-2 text-sm" value="{{ $prodi->kustomisasi?->secondary_color ?? '#000000' }}" placeholder="#000000">
                                    <input type="color" id="picker-secondary" value="{{ $prodi->kustomisasi?->secondary_color ?? '#000000' }}" class="w-10 h-10 border rounded-lg cursor-pointer">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="text" id="input-tertiary" name="tertiary_color" class="flex-1 border rounded-lg px-3 py-2 text-sm" value="{{ $prodi->kustomisasi?->tertiary_color ?? '#000000' }}" placeholder="#000000">
                                    <input type="color" id="picker-tertiary" value="{{ $prodi->kustomisasi?->tertiary_color ?? '#000000' }}" class="w-10 h-10 border rounded-lg cursor-pointer">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <input type="text" id="input-quaternary" name="quaternary_color" class="flex-1 border rounded-lg px-3 py-2 text-sm" value="{{ $prodi->kustomisasi?->quaternary_color ?? '#000000' }}" placeholder="#000000">
                                    <input type="color" id="picker-quaternary" value="{{ $prodi->kustomisasi?->quaternary_color ?? '#000000' }}" class="w-10 h-10 border rounded-lg cursor-pointer">
                                </div>
                            </div>
        ...
        <div id="modalEditProfil" class="fixed inset-0 bg-black/30 hidden items-center justify-center z-50">
            <div class="bg-white rounded-2xl w-[95%] max-w-[500px] p-4 md:p-8 relative shadow-xl">
                ...
                <form id="formEditProfil" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        <label class="block text-[#3307CC] font-medium mb-2">Judul</label>
                        <input id="editJudul" type="text" name="judul_lulusan" placeholder="Masukkan nama profil lulusan" class="w-full h-11 px-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3307CC]/20" required>
                    </div>
                    <div>
                        <label class="block text-[#3307CC] font-medium mb-2">Deskripsi</label>
                        <textarea id="editDeskripsi" rows="5" name="deskripsi_lulusan" placeholder="Masukkan deskripsi profil lulusan" class="w-full p-4 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-[#3307CC]/20" required></textarea>
                    </div>
                    <div class="mt-5">
                        <label class="block text-[#3307CC] font-medium mb-2">Foto</label>
                        <div class="flex items-center gap-4">

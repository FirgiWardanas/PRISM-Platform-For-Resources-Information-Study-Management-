            ...
            <main class="flex-1 flex flex-col h-full overflow-hidden">
                ...
                <div class="flex-1 overflow-y-auto px-2 pb-6 space-y-6">
                    ...
                    <div class="relative bg-gradient-to-r from-[#AD00F1] via-[#3700E9] to-[#009DFF]
                        text-white px-7 rounded-[24px] shadow-sm overflow-hidden flex items-center min-h-[170px]">
                    ...
                    <div class="grid grid-cols-3 gap-5">
                        ...
                        {{-- Program Studi --}}
                        <div class="bg-white rounded-[24px] p-5 border border-[#DDE8FF] shadow-[#0447945a] shadow-lg relative overflow-hidden">
                            <div class="absolute right-0 top-4 w-[8px] h-[75px] rounded-l-full bg-gradient-to-b from-[#067AFA] to-[#044894]"></div>
                        ...
                        {{-- Kurikulum --}}
                        <div class="bg-white rounded-[24px] p-5 border border-[#E8D7FF] shadow-[#5200c663] shadow-lg relative overflow-hidden">
                            <div class="absolute right-0 top-4 w-[8px] h-[75px] rounded-l-full bg-gradient-to-b from-[#9A55FF] to-[#5100C6]"></div>
                            <div class="flex items-center gap-4">
                        ...
                        {{-- Mata Kuliah --}}
                        <div class="bg-white rounded-[24px] p-5 border border-[#FFD9F7] shadow-[#a900c760] shadow-lg relative overflow-hidden">
                            <div class="absolute right-0 top-4 w-[8px] h-[75px] rounded-l-full bg-gradient-to-b from-[#E555FF] to-[#A900C7]"></div>
                            <div class="flex items-center gap-4">
                    ...
                    <div class="grid grid-cols-3 gap-5">
                        ...
                        <div class="col-span-2 bg-white p-5 rounded-2xl shadow-sm flex flex-col items-center">
                            <h4 class="text-xs font-bold text-[#1E293B] mb-6 text-center w-full">Jumlah SKS per semester</h4>
                            ...
                            @if($kurikulumAktif && count($sksPerSemester))
                                ...
                                @endphp
                                <div class="flex items-end justify-between w-full px-4 h-36 border-b border-gray-100 pb-2 relative">
                                    {{-- Y-axis label --}}
                                    <div class="absolute left-0 top-0 bottom-8 flex items-center">
                                        <div class="border border-[#3700E9] text-[#3700E9] p-1 rounded-xl flex flex-col items-center justify-center gap-1 h-full w-8">
                                            <span class="text-[14px]">🎓</span>
                                            <span class="text-[8px] font-bold uppercase tracking-widest [writing-mode:vertical-lr] rotate-180">Jumlah SKS</span>
                                        </div>
                                    </div>
                                    ...
                                    @foreach($sksPerSemester as $sem => $sks)
                                        ...
                                        @endphp
                                        <div class="flex flex-col items-center gap-1 {{ $sem === 1 ? 'ml-8' : '' }}" style="flex:1">
                        ...
                        <div class="bg-white p-5 rounded-2xl shadow-sm flex flex-col justify-between">
                            <div>
                                <div class="flex justify-between items-center mb-4">
                                    ...
                                    <span class="text-[10px] text-gray-400 font-medium">jumlah {{ $jumlahMatakuliah }}</span>
                                </div>
                                ...
                                <div class="space-y-3.5">
                                    @foreach($katConfig as $key => $cfg)
                                        ...
                                        <div class="flex items-center justify-between gap-2 text-xs">
                                            <span class="w-24 text-gray-600 font-medium text-[11px]">{{ $cfg['label'] }}</span>
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-lg">
                        <div class="flex items-center justify-between w-full mb-5 px-5">
                            <div></div>
                            <h1 class="text-2xl font-bold">
                                Kurikulum
                                @if($kurikulumAktif)
                                    <span class="text-sm font-normal text-gray-400 ml-2">{{ $kurikulumAktif->nama_kurikulum }}</span>
                                @endif
                            </h1>
                            <a href="/admin/kurikulum"
                                class="px-4 py-2 bg-gradient-to-r from-[#0282FD] to-[#3502CA] hover:scale-110 text-white rounded-full transition flex justify-center items-center gap-1 text-sm">
                                Selengkapnya
                                ...
                                @foreach($semesterData as $semester => $details)
                                    <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                                        ...
                                        <div onclick="toggleSemester(this)" class="flex justify-between items-center cursor-pointer">
                                            <span class="tracking-widest font-semibold text-[#001286]">SEMESTER {{ $semester }}</span>
                                            ...
                                            <div class="overflow-x-auto">
                                                <div class="min-w-[700px] rounded-t-lg overflow-hidden shadow border border-gray-300">
                                                    <table class="w-full text-[10px] sm:text-xs border-collapse">
                                                        <colgroup>
                                                            <col class="w-[40px]"><col class="w-[70px]">
                                                            <col class="w-[150px]"><col class="w-[50px]">
                                                            <col class="w-[40px]"><col class="w-[40px]">
                                                            <col class="w-[40px]"><col class="w-[40px]">
                                                            <col class="w-[90px]"><col class="w-[70px]">
                                                        </colgroup>
                                                        <thead>

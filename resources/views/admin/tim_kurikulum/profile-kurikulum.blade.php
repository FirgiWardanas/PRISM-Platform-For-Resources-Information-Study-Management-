<x-layout.layout>
   ...
   <x-slot:title>Profil</x-slot:title>
    ...
    <body class="font-montserrat min-h-screen bg-cover bg-center bg-no-repeat bg-fixed"
            ...
            <x-admin.header_kurikulum>
                ...
                <div class="relative rounded-2xl bg-white p-6 md:p-10 shadow-xl min-h-[300px] border border-gray-300">
                    ...
                    <form method="POST" action="{{ route('logout') }}"
                        class="mt-6 flex justify-end md:absolute md:bottom-6 md:right-10 w-full z-10">
                        @csrf
                        <button type="submit"
                    ...
                    <form method="POST" action="{{ route('admin.profile-tim-kurikulum.update', $user->id_user) }}">
                        ...
                        <label>
                            ...
                            <input type="text" name="nama" value="{{ $user->nama }}"
                                class="py-2 px-3 border border-gray-300 shadow-md rounded w-full block text-sm mb-2">
                        ...
                        <div class="flex justify-center">
                            <button type="submit"
                                class="w-40 mx-auto rounded-xl bg-gradient-to-r from-[#0282FD] to-[#3502CA] py-2 text-white font-semibold cursor-pointer hover:scale-[1.025] transition-all hover:opacity-90 mt-4">
                                Simpan
                            </button>
                        </div>
                    </form>
        ...
        <script src="{{ asset('js/profil_tim-kurikulum.js') }}"></script>

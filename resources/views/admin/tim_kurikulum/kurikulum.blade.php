<x-layout.layout>
        ...
        <main class="flex-1  px-4">
            ...
            <div class="flex gap-4 h-[90%]">
                ...
                <div class="w-48 space-y-3 mt-5">
                    ...
                    <div class="bg-gradient-to-r from-[#4363E3] to-[#9A55FF] text-white p-5 rounded-lg mx-auto">
                        Kurikulum 8
                    </div>

                    <div class="bg-[#B3C3FF] text-[#001286] p-3 rounded-lg">Kurikulum 7</div>
                    <div class="bg-[#B3C3FF] text-[#001286] p-3 rounded-lg">Kurikulum 6</div>
                    <div class="bg-[#B3C3FF] text-[#001286] p-3 rounded-lg">Kurikulum 5</div>
                    <div class="bg-[#B3C3FF] text-[#001286] p-3 rounded-lg">Kurikulum 4</div>
                    <div class="bg-[#B3C3FF] text-[#001286] p-3 rounded-lg">Kurikulum 3</div>

                </div>

                <!-- Content Semester -->
                <div class="flex-1 bg-white rounded-2xl shadow p-6 overflow-y-auto mb-4">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex gap-3">
                            <button onclick="editKurikulum()">
                                <img src="{{ asset('images/icon-edit.png') }}" alt="hapus" class="w-6 h-6 cursor-pointer"> </button>
                            <img src="{{ asset('images/icon-hapus.png') }}" alt="edit" class="w-7 h-7" onclick="hapusKurikulum(this)">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah" onclick="openModalMatkul()"
                            ...
                            <!--content table-->
                            <div id="semesterContent" class="mt-3 hidden">
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah()">
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester2()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow2" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah2" onclick="openModalMatkul2()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent2" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus2()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah2()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester3()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow3" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah3" onclick="openModalMatkul3()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent3" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus3()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah3()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester4()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow4" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah4" onclick="openModalMatkul4()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent4" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus4()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah4()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester5()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow5" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah5" onclick="openModalMatkul5()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent5" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus5()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah5()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester6()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow6" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah6" onclick="openModalMatkul6()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent6" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus6()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah6()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                                                            onclick="hapusMatakuliah(this)">
                                                    </div>
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester7()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow7" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah7" onclick="openModalMatkul7()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent7" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus7()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah7()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
                       ...
                       <div class="bg-white rounded-xl p-4 shadow-md border border-gray-300">
                            ...
                            <div onclick="tooglesemester8()" class="flex justify-between items-center cursor-pointer">
                                ...
                                <img id="iconarrow8" src="{{ asset('images/icon-dropdown.svg') }}"
                                    class="h-5 w-5 transition-transform duration-300">
                            </div>
                            <!-- BUTTON TAMBAH (DI BAWAH KANAN) -->
                            <div class="flex justify-end">
                                <button id="btnTambah8" onclick="openModalMatkul8()"
                                    class="hidden mt-2 text-sm bg-gradient-to-r from-[#0282FD] to-[#3502CA] text-white px-2 py-1 rounded-lg shadow text-center flex items-center justify-center gap-1 cursor-pointer">
                                    Tambah <img src="{{ asset('images/icon-plus.svg') }}" class="h-5 w-5">
                                </button>
                            </div>
                            ...
                            <!--content table-->
                            <div id="semesterContent8" class="mt-3 hidden">
                                <div class="rounded-t-lg overflow-hidden shadow border border-gray-300">
                                    <table class="w-full  text-xs border-collapse">
                                        <!-- ATUR LEBAR KOLOM -->
                                        <colgroup>
                                        ...
                                        <tbody>
                                            <tr class="text-[10px] text-center">
                                                ...
                                                <td class="p-2 flex justify-center items-center">
                                                    <img src="{{ asset('images/icon-silabuskurikulum.svg') }}" class="cursor-pointer"
                                                        onclick="openModalSilabus8()">
                                                </td>

                                                <td class="p-2">
                                                    <div class="flex justify-center items-center gap-2">
                                                        <img src="{{ asset('images/icon-edit.svg') }}" class="w-3 h-3 cursor-pointer"
                                                            onclick="openEditMatakuliah8()">
                                                        <img src="{{ asset('images/icon-hapus.svg') }}"
                                                            class="w-4 h-4 cursor-pointer"
    ...
    <!--popupsukses edit-->
    <div id="popupSuksesEdit" class="fixed top-5 right-5 hidden bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg">
        ✅ Data berhasil disimpan
    </div>
            ...
            <form action="">
                <div class="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <label for="Kategori">
                        ...
                        <div class="relative">
                            <select class="w-full px-3 py-2 border border-gray-300 shadow-lg rounded-lg appearance-none"
                                id="kategori">
                                <option>--Pilih--</option>
                                <option>Wajib</option>
...
<!-- modaltambahmatakuliah semester 2 -->
    <div id="modalMatkul2" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul2()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul3" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul3()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul4" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul4()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul5" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul5()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul6" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul6()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul7" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul7()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalMatkul8" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeModalMatkul8()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
            ...
            <div class="p-5">
                <div class="overflow-y-auto max-h-[80vh]">
                    ...
                    <div class="flex justify-center py-4 border-t">
                        <button type="button" onclick="simpansilabus1()"
    ...
    <div id="modalSilabus2" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus2()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus3" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus3()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus4" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus4()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus5" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus5()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus6" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus6()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus7" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus7()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalSilabus8" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
            ...
            <div class="flex justify-center items-center  py-3 relative">
                ...
                <button onclick="closeModalSilabus8()"
                    class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center cursor-pointer">
                    ✕
                </button>
            </div>
    ...
    <div id="modalEditMatakuliah" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
...
<!--modaleditmatakuliah semester 2-->
    <div id="modalEditMatakuliah2" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah2()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah3" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah3()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah4" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah4()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah5" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah5()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah6" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah6()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah7" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah7()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>
    ...
    <div id="modalEditMatakuliah8" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
        ...
        <div class="w-[800px] bg-white rounded-2xl p-6 shadow-xl relative">
            ...
            <!-- CLOSE -->
            <button onclick="closeEditMatakuliah8()"
                class="absolute top-4 right-4 w-8 h-8 rounded-full bg-blue-600 text-white cursor-pointer">
                ✕
            </button>

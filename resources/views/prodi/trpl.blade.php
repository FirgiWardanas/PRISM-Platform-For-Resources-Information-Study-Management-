...
<head>
  ...
  <title>halaman teknologi Rekayasa Perangkat Lunak</title>
...
<body class=" font-[Montserrat] ">
  <div class="min-h-screen w-full bg-cover bg-bottom bg-no-repeat text-white" style="background-image: url('{{ asset('images/bg-trpl.png') }}')">
    <header class="w-full fixed z-100 bg-[#003883]">
      <nav class="flex justify-between items-center border-b-1 px-8 py-3">
        ...
        <div class="flex items-center gap-20">
          <ul class="hidden lg:flex gap-20 font-bold text-xs">
            <li>
              <a href="#home" class="hover:text-[#F5C45A] transition duration-300 cursor-pointer">Beranda</a>
            </li>
            <li>
              <a href="#tentang" class="hover:text-[#F5C45A] transition duration-300 cursor-pointer">Tentang Kami</a>
            </li>
            <li>
              <a href="#visimisi" class="hover:text-[#F5C45A] transition duration-300 cursor-pointer">Visi Misi</a>
            </li>
            <li>
              <a href="#kurikulum" class="hover:text-[#F5C45A] transition duration-300 cursor-pointer">Kurikulum</a>
            </li>
            <li>
              <a href="#dosen" class="hover:text-[#F5C45A] transition duration-300 cursor-pointer">Dosen</a>
            </li>
          </ul>

          <div class="hidden lg:flex">
            <button
              class="bg-gradient-to-r from-[#E59C00] to-[#F5C45A] shadow-2xl px-8 py-2 rounded-lg text-primary text-xs font-bold hover:from-[#8f6100] hover:to-[#F5C45A] hover:cursor-pointer hover:scale-105 transition">
              LOGIN
            </button>
          </div>
        </div>
      ...
      <div id="mobile-menu"
        ...
        <div class="flex flex-col gap-4 mt-4 px-2">
          <button
            class="bg-gradient-to-r from-[#E59C00] to-[#F5C45A] shadow-2xl px-8 py-3 rounded-lg text-white text-xs font-bold transition duration-200 hover:from-[#8f6100] hover:to-[#F5C45A] hover:scale-102 hover:cursor-pointer">
            LOGIN
          </button>
        </div>
      </div>
    ...
    <section id="home"
      ...
      <div class="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div class="text-center md:text-left space-y-2">
          ...
          <img src="{{ asset('images/logo-trpl.png') }}" class="w-24 sm:w-28 md:w-32 mx-auto md:mx-0">
          ...
          <button class="bg-gradient-to-r from-[#E59C00] to-[#F5C45A]
        ...
        <div class="flex justify-center">
          <img src="{{ asset('images/illustrasi-trpl.png') }}"  class="w-52 sm:w-64 md:w-88 sm:w-64 md:w-80 lg:w-[420px]
  ...
  ">
    <div class="flex flex-col justify-center items-center">
      <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-3 text-[#002658] text-center">Teknologi Rekayasa Perangkat Lunak</h1>
      <h1 class="text-2xl md:text-3xl font-semibold lg:text-4xl mb-3 text-[#5CAEFF]">Diploma 4</h1>
      <p class="text-center mb-12">Program Studi D4 Rekayasa Perangkat Lunak berfokus menyiapkan lulusan sarjana terapan pada bidang pengembangan perangkat lunak yang memiliki kemampuan analisis, desain, perancangan, validasi, pengembangan (Pemograman), penjamin kualitas dan keamanan perangkat lunak (Software) untuk menghasilkan karya teknologi yang dapat berfungsi secara efektif dan efisien serta mampu mandiri menjadi seorang Technopreneur yang dapat bermanfaat bagi Batam serta Indonesia.</p>
  ...
  <section id="visimisi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-40">
    ...
    <div class="absolute top-20 -left-20 w-80 z-0">
      <img src="{{ asset('images/ring-trpl.png') }}" alt="">
    </div>
    ...
    <!-- TITLE -->
    <h1 class="text-3xl md:text-5xl font-bold text-[#002658] mb-16 text-center">
      Visi Misi
    </h1>
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6 z-10">
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 text-[#B0D1FF]">
          01
        </h1>

        <p class="font-bold text-[#002658] mb-3 text-lg md:text-xl">
          Visi Prodi TRPL
        </p>
  ...
  <section class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-[#002658] text-center">Profil Lulusan</h1>
    ...
    <div
      ...
      <div class="relative w-full h-full">
        ...
        <div
          class="slide absolute left-1/2 w-[90%] md:w-[700px] h-[380px] md:h-[300px] rounded-3xl bg-gradient-to-br from-[#007BBD] to-[#00D4FF] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-10 shadow-2xl transition-all duration-500">
          ...
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Programmer</h1>
            <p class="text-[10px] md:text-sm mt-2 leading-relaxed">Seseorang yang memiliki kemampuan atau skill menulis dan merancang kode program-program (syntax) komputer.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Mobile Application Developer</h1>
            <p class="text-[10px] md:text-sm mt-2">Programmer yang terlatih membuat produk berupa aplikasi mobile.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}"class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">IoT Application Developer</h1>
            <p class="text-[10px] md:text-sm mt-2">Programmer yang mampu membuat produk aplikasi berbasis IoT (Internet of Things).</p>
          </div>
        </div>
  ...
  <section id="kurikulum" class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-6 text-[#002658] text-center">
      Kurikulum
    </h1>
    ...
    <div class="w-full max-w-5xl mx-auto mt-4 p-4 md:p-6 flex flex-wrap">
      ...
      <label for="tab1" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C4DAED]
      font-bold cursor-pointer text-[#145884]
      peer-checked/tab1:bg-[#86B8DE] peer-checked/tab1:text-white
      rounded-t-xl text-sm md:text-base">
        Aktif
      </label>

      <div class="w-full px-4 md:px-10 py-10 md:py-20 bg-[#86B8DE]
      ...
      <label for="tab2" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C4DAED]
      font-bold cursor-pointer text-[#145884]
      peer-checked/tab2:bg-[#86B8DE] peer-checked/tab2:text-white
      rounded-t-xl text-sm md:text-base">
        Tidak Aktif
      </label>

      <div class="w-full p-4 md:p-12 bg-[#86B8DE]
    ...
    rounded-lg shadow bg-white text-[#01295B]
  ...
  <section id="dosen" class="max-w-4xl mx-auto py-10 flex flex-col items-center px-5">
    ...
    <!-- Title -->
    <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-12 text-[#01295B] ">Dosen</h1>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(1)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trpl1.png') }}"  class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#01295B]">Supardianto, M.Eng.</h2>
            <p class="text-gray-500">Kepala Program Studi Teknologi Rekayasa Perangkat Lunak</p>
          </div>
        </div>

        <span id="icon-1" class="text-[#01295B] text-xl transition-transform duration-300"><img
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Email :</b> supardianto@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#01295B] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Bandung : Teknik Media Digital</p>
              <p>Magister (S2) Universitas Gadjah Mada : Teknologi Infomasi</p>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(2)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trpl2.png') }}"  class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#01295B]">Ahmadi Irmansyah Lubis, S.Kom., M.Kom.</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-2" class="text-[#01295B] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknologi Rekayasa Perangkat Lunak</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> ahmadi@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#01295B] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Sumatera Utara : Teknologi Informasi</p>
              <p>Magister (S2) Universitas Sumatera Utara : Teknik Informatika</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Artificial Intelligence, Decision Support System, Machine Learning, Computer Science</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(3)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trpl3.png') }}"  class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#01295B]">Noper Ardi, S.Pd., M.Eng</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-3" class="text-[#01295B] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknologi Rekayasa Perangkat Lunak</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> noperardi@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#01295B] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Negeri Padang : Pendidikan Teknik Informatika dan Komputer</p>
              <p>Magister (S2) Universitas Gadjah Mada : Teknologi Informasi</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> RPL, AI</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="kontak" class=" bg-cover bg-center bg-no-repeat text-white" style="background-image: url('{{ asset('images/footer-trpl.png') }}')">
    ...
    <!-- COPYRIGHT -->
    <div class="bg-gradient-to-r from-[#E6A008] to-[#F4C154] text-center text-sm py-2">
  ...
  <script>
    document.onclick = e => {
      ...
      document.querySelectorAll('.kur-btn')
        .forEach(b => {
          b.classList.remove('bg-gradient-to-b', 'from-[#01295B]', 'to-[#016DAE]', 'text-white');
          b.classList.add('bg-white', 'text-[#01295B]');
        });

      // aktif gradient
      e.target.classList.remove('bg-white', 'text-[#01295B]');
      e.target.classList.add('bg-gradient-to-b', 'from-[#01295B]', 'to-[#016DAE]', 'text-white');
    };

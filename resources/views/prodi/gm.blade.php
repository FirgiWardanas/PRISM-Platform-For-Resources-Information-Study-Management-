...
<head>
  ...
  <title>halaman teknologi geomatika</title>
...
<body class=" font-[Montserrat] ">
      ...
      <nav class="flex justify-between items-center border-b-1 px-8 py-3">
        ...
        <div class="flex items-center gap-20">
          <ul class="hidden lg:flex gap-20 font-bold text-xs">
            <li>
              <a href="#home" class="hover:text-[#E8A300] transition duration-300 cursor-pointer">Beranda</a>
            </li>
            <li>
              <a href="#tentang" class="hover:text-[#E8A300] transition duration-300 cursor-pointer">Tentang Kami</a>
            </li>
            <li>
              <a href="#visimisi" class="hover:text-[#E8A300] transition duration-300 cursor-pointer">Visi Misi</a>
            </li>
            <li>
              <a href="#kurikulum" class="hover:text-[#E8A300] transition duration-300 cursor-pointer">Kurikulum</a>
            </li>
            <li>
              <a href="#dosen" class="hover:text-[#E8A300] transition duration-300 cursor-pointer">Dosen</a>
            </li>
          </ul>
    ...
    <section id="home"
      ...
      <div class="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div class="text-center md:text-left space-y-2">
          ...
          <img src="{{ asset('images/logo-gm.png') }}" class="w-24 sm:w-28 md:w-32 mx-auto md:mx-0">
          ...
          <button class="bg-gradient-to-r from-[#FCD500] to-[#E8A300] 
        ...
        <div class="flex justify-center">
          <img src="{{ asset('images/illustrasi-gm.png') }}" class="w-52 sm:w-64 md:w-88 sm:w-64 md:w-80 lg:w-[420px]
  ...
  <section id="visimisi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-40">
    ...
    <div class="absolute top-20 -left-20 w-80 z-0">
      <img src="{{ asset('images/ring-gm.png') }}" alt="">
    </div>
    ...
    <!-- TITLE -->
    <h1 class="text-3xl md:text-5xl font-bold text-[#296300] mb-16 text-center">
      Visi Misi
    </h1>
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6 z-10">
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 text-[#AAD98A]">
          01
        </h1>

        <p class="font-bold text-[#296300] mb-3 text-lg md:text-xl">
          Visi Prodi GM
        </p>
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <p class="text-sm md:text-base text-justify leading-relaxed">
          Aktif dalam proses kreasi, penyebaran dan penerapan sains dan teknologi dibidang keilmuan geomatika/geospasial meliputi survei terestris, survei hidrografi, sistem informasi geografis, dan fotogrametri, melalui layanan pendidikan tinggi vokasi dan penelitian terapan yang bermutu, terbuka, relevan, dan berkolaborasi erat dengan masyarakat dan industri dengan penerapan tata kelola program studi yang baik untuk kehidupan bangsa yang lebih baik.
        </p>
  ...
  <section class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-[#296300] text-center">Profil Lulusan</h1>
    ...
    <div
      ...
      <div class="relative w-full h-full">
        ...
        <div
          class="slide absolute left-1/2 w-[90%] md:w-[700px] h-[380px] md:h-[300px] rounded-3xl bg-gradient-to-br from-[#008C5D] to-[#90F600] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-10 shadow-2xl transition-all duration-500">
          ...
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Surveyor Hidrografi</h1>
            <p class="text-[10px] md:text-sm mt-2 leading-relaxed">Seseorang yang Memiliki pengetahuan dan kemampuan praktis dalam penentuan posisi dan survey pemetaan laut dan pesisir.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Surveyor Engineering</h1>
            <p class="text-[10px] md:text-sm mt-2">Seseorang yang Memiliki kemampuan praktis dalam penentuan posisi dan survey pemetaan di bidang rancang bangun dan kontruksi.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Teknisi/Spesialis GIS</h1>
            <p class="text-[10px] md:text-sm mt-2">Seseorang yang Mampu melakukan konversi data geospasial, editing data geospasial, dan pengujian kualitas data geospasial. Mampu melakukan pra-pemrosesan radiometrik inisial, pemrosesan citra digital, menyusun mosaic citra digital, dan pengukuran spektrometri lapangan untuk menyusun spektral library.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Pengembang Aplikasi Geospasial</h1>
            <p class="text-[10px] md:text-sm mt-2">Seseorang yang Mampu menyelesaikan suatu kasus/masalah menjadi sebuah algoritma, flowchart kemudian mengimplementasikan menjadi sebuah program komputer.</p>
          </div>
        </div>
  ...
  <section id="kurikulum" class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-6 text-[#296300] text-center">
      Kurikulum
    </h1>
    ...
    <div class="w-full max-w-5xl mx-auto mt-4 p-4 md:p-6 flex flex-wrap">
      ...
      <label for="tab1" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C8EDC4]
      font-bold cursor-pointer text-[#238414]
      peer-checked/tab1:bg-[#92DE86] peer-checked/tab1:text-white
      rounded-t-xl text-sm md:text-base">
        Aktif
      </label>

      <div class="w-full px-4 md:px-10 py-10 md:py-20 bg-[#92DE86]
      ...
      <label for="tab2" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C8EDC4]
      font-bold cursor-pointer text-[#238414]
      peer-checked/tab2:bg-[#92DE86] peer-checked/tab2:text-white
      rounded-t-xl text-sm md:text-base">
        Tidak Aktif
      </label>

      <div class="w-full p-4 md:p-12 bg-[#92DE86]
    ...
    rounded-lg shadow bg-white text-[#2E6C04]
  ...
  <section id="dosen" class="max-w-4xl mx-auto py-10 flex flex-col items-center px-5">
    ...
    <!-- Title -->
    <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-12 text-[#296300] ">Dosen</h1>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(1)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-gm1.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#296300]">Ir. Farouki Dinda Rassarandi, S.T., M.Eng.</h2>
            <p class="text-gray-500">Kepala Program Studi Teknologi Geomatika</p>
          </div>
        </div>

        <span id="icon-1" class="text-[#296300] text-xl transition-transform duration-300"><img
      ...
      <div id="content-1" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            ...
            <div>
              <p class="font-bold text-[#296300] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Nasional (ITN) Malang : Teknik Geodesi</p>
              <p>Magister (S2) Universitas Gadjah Mada (UGM) : Teknologi Geomatika</p>
              <p>PSPPI Politeknik Negeri Batam</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Survei Terestris & Geoinformatika</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(2)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-gm2.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#296300]">Ir. Sudra Irawan, S.Pd.Si., M.Sc., IPM.</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-2" class="text-[#296300] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknologi Geomatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> sudra@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#296300] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Negeri Yogyakarta : Pendidikan Fisika</p>
              <p>Magister (S2) Universitas Gadjah Mada : Fisika</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Geoscience, Geophysics, Hydro-oceanography, Geology, GIS</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(3)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-gm3.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#296300]">Ir. Oktavianto Gustin, S.T., M.T., IPM.</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-3" class="text-[#296300] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknologi Geomatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> oktavianto@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#296300] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Sepuluh Nopember Surabaya : Teknologi Geomatika</p>
              <p>Magister (S2) Institut Teknologi Sepuluh Nopember Surabaya: Teknologi Geomatika</p>
              <p>PSPPI Institut Teknologi Bandung</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> GNSS, Remote Sensing, Engineering Survey</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="kontak" class=" bg-cover bg-center bg-no-repeat text-white" style="background-image: url('{{ asset('images/footer-gm.png') }}')">
    ...
    <!-- COPYRIGHT -->
    <div class="bg-gradient-to-r from-[#E8A401] to-[#FDD800] text-center text-sm py-2">
  ...
  <script>
    document.onclick = e => {
      ...
      document.querySelectorAll('.kur-btn')
        .forEach(b => {
          b.classList.remove('bg-gradient-to-b', 'from-[#2E6C04]', 'to-[#45950D]', 'text-white');
          b.classList.add('bg-white', 'text-[#014B53]');
        });

      // aktif gradient
      e.target.classList.remove('bg-white', 'text-[#014B53]');
      e.target.classList.add('bg-gradient-to-b', 'from-[#2E6C04]', 'to-[#45950D]', 'text-white');
    };

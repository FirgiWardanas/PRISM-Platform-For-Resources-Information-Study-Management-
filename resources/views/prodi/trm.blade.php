...
<head>
  ...
  <title>halaman teknologi rekayasa multimedia</title>
...
<body class=" font-[Montserrat] ">
  <div class="min-h-screen w-full bg-cover bg-bottom bg-no-repeat text-white" style="background-image: url('{{ asset('images/bg-trm.png') }}')">
    <header class="w-full fixed z-100 bg-[#7E0000]">
      <nav class="flex justify-between items-center border-b-1 px-8 py-3">
        ...
        <div class="flex items-center gap-20">
          <ul class="hidden lg:flex gap-20 font-bold text-xs">
            <li>
              <a href="#home" class="hover:text-[#256AFE] transition duration-300 cursor-pointer">Beranda</a>
            </li>
            <li>
              <a href="#tentang" class="hover:text-[#256AFE] transition duration-300 cursor-pointer">Tentang Kami</a>
            </li>
            <li>
              <a href="#visimisi" class="hover:text-[#256AFE] transition duration-300 cursor-pointer">Visi Misi</a>
            </li>
            <li>
              <a href="#kurikulum" class="hover:text-[#256AFE] transition duration-300 cursor-pointer">Kurikulum</a>
            </li>
            <li>
              <a href="#dosen" class="hover:text-[#256AFE] transition duration-300 cursor-pointer">Dosen</a>
            </li>
          </ul>

          <div class="hidden lg:flex">
            <button
              class="bg-gradient-to-r from-[#256AFE] to-[#5AA7F5] shadow-2xl px-8 py-2 rounded-lg text-primary text-xs font-bold hover:from-[#1557e6] hover:to-[#378fe7]hover:cursor-pointer hover:scale-105 transition">
              LOGIN
            </button>
          </div>
        </div>
      ...
      <div id="mobile-menu"
        ...
        <div class="flex flex-col gap-4 mt-4 px-2">
          <button
            class="bg-gradient-to-r from-[#256AFE] to-[#5AA7F5]  shadow-2xl px-8 py-3 rounded-lg text-white text-xs font-bold transition duration-200 hover:from-[#1557e6] hover:to-[#378fe7] hover:scale-102 hover:cursor-pointer">
            LOGIN
          </button>
        </div>
      </div>
    ...
    <section id="home"
      ...
      <div class="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div class="text-center md:text-left space-y-2">
          ...
          <img src="{{ asset('images/logo-trm.png') }}" class="w-24 sm:w-28 md:w-32 mx-auto md:mx-0">
          ...
          <button class="bg-gradient-to-r from-[#256AFE] to-[#5AA7F5]
        ...
        <div class="flex justify-center">
          <img src="{{ asset('images/illustrasi-trm.png') }}" class="w-52 sm:w-64 md:w-88 sm:w-64 md:w-80 lg:w-[420px]
  ...
  ">
    <div class="flex flex-col justify-center items-center">
      <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-3 text-[#A42E01] text-center">Teknologi Rekayasa Multimedia</h1>
      <h1 class="text-2xl md:text-3xl font-semibold lg:text-4xl mb-3 text-[#E77000]">Diploma 4</h1>
      <p class="text-center mb-12">D4 Program Studi Program Studi Sarjana Terapan Teknologi Rekayasa Multimedia Politeknik Negeri Batam fokus untuk menyiapkan lulusan yang memiliki kompetensi pada bidang multimedia serta memiliki kemampuan tambahan di bidang informatika untuk menghasilkan karya teknologi yang dapat berguna serta dapat diimplementasikan di dunia industri. Secara umum, mahasiswa prodi Teknologi Rekayasa Multimedia akan menempuh perkuliahan selama 8 semester atau 4 tahun.</p>
  ...
  <section id="visimisi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-40">
    ...
    <div class="absolute top-20 -left-20 w-80 z-0">
      <img src="{{ asset('images/ring-trm.png') }}" alt="">
    </div>
    ...
    <!-- TITLE -->
    <h1 class="text-3xl md:text-5xl font-bold text-[#A42E01] mb-16 text-center">
      Visi Misi
    </h1>
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6 z-10">
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 text-[#FFD4A0]">
          01
        </h1>

        <p class="font-bold text-[#A42E01] mb-3 text-lg md:text-xl">
          Visi Prodi TRM
        </p>

        <p class="text-sm md:text-base text-justify leading-relaxed">
          Menjadi program studi vokasional yang bermutu, unggul, adaptif, inovatif, dan bermitra erat dengan industri dan masyarakat di bidang multimedia untuk mendukung Indonesia Maju dan Sejahtera 2045.
        </p>
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <p class="text-sm md:text-base text-justify leading-relaxed">
          Aktif dalam proses kreasi, penyebaran dan penerapan sains dan teknologi di bidang multimedia melalui layanan pendidikan tinggi vokasi dan penelitian terapan yang bermutu, terbuka, relevan, dan berkolaborasi erat dengan masyarakat dan industri dengan penerapan tata kelola institusi yang baik untuk kehidupan bangsa yang lebih baik.
        </p>
  ...
  <section class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-[#A42E01] text-center">Profil Lulusan</h1>
    ...
    <div
      ...
      <div class="relative w-full h-full">
        ...
        <div
          class="slide absolute left-1/2 w-[90%] md:w-[700px] h-[380px] md:h-[300px] rounded-3xl bg-gradient-to-br from-[#D52700] to-[#FF9D00] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-10 shadow-2xl transition-all duration-500">
          ...
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Graphic Designer</h1>
            <p class="text-[10px] md:text-sm mt-2 leading-relaxed">Menciptakan karya desain bedasarkan alternatif konsep berlandaskan prinsip desain dan komunikasi. Menyusun dan mengukur penyelesaian design brief dan memformulasikan serta mendokumentasikan proses desain secara utuh, hingga materi siap produksi/tayang. Menyusun dan mempresentasikan isi pemikiran dan proses pembuatan karya desain. Mengembangkan kualitas pekerjaan yang meningkatkan reputasi organisasi, keilmuan, dan profesi;</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}"class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Photographer</h1>
            <p class="text-[10px] md:text-sm mt-2">Mengidentifikasi dan mengembangan gagasan dari konsumen. Melakukan pembagian tugas dan koordinasi dalam tim kerja. Menerapkan prosedur Keselamatan dan Kesehatan Kerja (K3) pada bidang fotografi. Menentukan jenis peralatan fotografi untuk pengambilan gambar. Menentukan arah, warna, dan kualitas cahaya untuk pemotretan;</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}"class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Scriptwriter</h1>
            <p class="text-[10px] md:text-sm mt-2">Menulis dan mengembangkan naskah. Membuat konsep cerita yang sesuai dengan visi produser dan kebutuhan audiens. Melakukan riset mendalam untuk memastikan keakuratan dan relevansi cerita. Menyusun struktur dan alur cerita. Kolaborasi dengan Tim Produksi;</p>
          </div>
        </div>
  ...
  <section id="kurikulum" class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-6 text-[#A42E01] text-center">
      Kurikulum
    </h1>
    ...
    <div class="w-full max-w-5xl mx-auto mt-4 p-4 md:p-6 flex flex-wrap">
      ...
      <label for="tab1" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#EDD7C4]
      font-bold cursor-pointer text-[#845214]
      peer-checked/tab1:bg-[#DEA686] peer-checked/tab1:text-white
      rounded-t-xl text-sm md:text-base">
        Aktif
      </label>

      <div class="w-full px-4 md:px-10 py-10 md:py-20 bg-[#DEA686]
      ...
      <label for="tab2" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#EDD7C4]
      font-bold cursor-pointer text-[#845214]
      peer-checked/tab2:bg-[#DEA686] peer-checked/tab2:text-white
      rounded-t-xl text-sm md:text-base">
        Tidak Aktif
      </label>

      <div class="w-full p-4 md:p-12 bg-[#DEA686]
    ...
    rounded-lg shadow bg-white text-[#A62E01]
  ...
  <section id="dosen" class="max-w-4xl mx-auto py-10 flex flex-col items-center px-5">
    ...
    <!-- Title -->
    <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-12 text-[#A62E01] ">Dosen</h1>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(1)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trm1.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#A62E01]">Happy Yugo Prasetiya, S.Sn., M.Sn</h2>
            <p class="text-gray-500">Kepala Program Studi Teknologi Rekayasa Permainan</p>
          </div>
        </div>

        <span id="icon-1" class="text-[#A62E01] text-xl transition-transform duration-300"><img
      ...
      <div id="content-1" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              <p><b>NIK :</b> 112092</p>
              <p><b>Program Studi :</b> Teknologi Rekayasa Multimedia</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> yugo@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#A62E01] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Negeri Malang : Desain Komunikasi Visual</p>
              <p>Magister (S2) ISI Yogyakarta : Pengkajian Seni Desain Komunikasi Visual</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Desain Komunikasi Visual & Animasi</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(2)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trm2.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#A62E01]">Gendhy Dwi Harlyan, S.Sn.,M.Sn</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-2" class="text-[#A62E01] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(3)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-trm3.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#A62E01]">Sandi Prasetyaningsih, S.ST., M.Media</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-3" class="text-[#A62E01] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknologi Rekayasa Multimedia</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> sandi@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#A62E01] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana Terapan (DIV) Institut Teknologi Bandung : Desain Komunikasi Visual - Animasi</p>
              <p>Magister (S2) RMIT University: Master of Media</p>
              <p class="mt-2"><b>Media</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="kontak" class="bg-cover bg-center bg-no-repeat text-white" style="background-image: url('{{ asset('images/footer-trm.png') }}')">
    ...
    <!-- COPYRIGHT -->
    <div class="bg-gradient-to-r from-[#2B70FD] to-[#57A4F6] text-center text-sm py-2">
  ...
  <script>
    document.onclick = e => {
      ...
      document.querySelectorAll('.kur-btn')
        .forEach(b => {
          b.classList.remove('bg-gradient-to-b', 'from-[#A62E01]', 'to-[#FF4A0D]', 'text-white');
          b.classList.add('bg-white', 'text-[#A62E01]');
        });

      // aktif gradient
      e.target.classList.remove('bg-white', 'text-[#A62E01]');
      e.target.classList.add('bg-gradient-to-b', 'from-[#A62E01]', 'to-[#FF4A0D]', 'text-white');
    };

...
<body class=" font-[Montserrat] ">
  <div class="min-h-screen w-full bg-cover bg-bottom bg-no-repeat text-white" style="background-image: url('{{ asset('images/bg-if.png') }}')">
    <header class="w-full fixed z-100 bg-[#136479]">
      <nav class="flex justify-between items-center border-b-1 px-8 py-3">
        ...
        <div class="flex items-center gap-20">
          <ul class="hidden lg:flex gap-20 font-bold text-xs">
            <li>
              <a href="#home" class="hover:text-[#FE2574] transition duration-300 cursor-pointer">Beranda</a>
            </li>
            <li>
              <a href="#tentang" class="hover:text-[#FE2574] transition duration-300 cursor-pointer">Tentang Kami</a>
            </li>
            <li>
              <a href="#visimisi" class="hover:text-[#FE2574] transition duration-300 cursor-pointer">Visi Misi</a>
            </li>
            <li>
              <a href="#kurikulum" class="hover:text-[#FE2574] transition duration-300 cursor-pointer">Kurikulum</a>
            </li>
            <li>
              <a href="#dosen" class="hover:text-[#FE2574] transition duration-300 cursor-pointer">Dosen</a>
            </li>
          </ul>
    ...
    <section id="home"
      ...
      <div class="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div class="text-center md:text-left space-y-2">
          ...
          <img src="{{ asset('images/logo-if.png') }}" class="w-24 sm:w-28 md:w-32 mx-auto md:mx-0">
          ...
          <button class="bg-gradient-to-r from-[#FE2574] to-[#F55A93]
        ...
        <div class="flex justify-center">
          <img src="{{ asset('images/illustrasi-if.png') }}" class="w-52 sm:w-64 md:w-88 sm:w-64 md:w-80 lg:w-[420px]
  ...
  ">
    <div class="flex flex-col justify-center items-center">
      <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-3 text-[#065862] text-center">Teknik Informatika</h1>
      <h1 class="text-2xl md:text-3xl font-semibold lg:text-4xl mb-3 text-[#03AABB]">Diploma 3</h1>
      <p class="text-center mb-12">Teknik Informatika merupakan program studi yang mengkhususkan pada pengembangan
        aplikasi software dan hardware untuk tujuan tertentu. Lulusan memiliki keterampilan yang baik di bidang
        pemrograman dan jaringan serta kemampuan tambahan di bidang multimedia.</p>
  ...
  <section id="visimisi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-40">
    ...
    <div class="absolute top-20 -left-20 w-80 z-0">
      <img src="{{ asset('images/ring-if.png') }}" alt="">
    </div>
    ...
    <!-- TITLE -->
    <h1 class="text-3xl md:text-5xl font-bold text-[#065862] mb-16 text-center">
      Visi Misi
    </h1>
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6 z-10">
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 text-[#8AD1D9]">
          01
        </h1>

        <p class="font-bold text-[#00766D] mb-3 text-lg md:text-xl">
          Visi Prodi IF
        </p>

        <p class="text-sm md:text-base text-justify leading-relaxed">
          Menjadi program studi vokasional yang bermutu, unggul, adaptif, inovatif,
          dan bermitra erat dengan industri dan masyarakat di bidang Teknik Informatika
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <p class="text-sm md:text-base text-justify leading-relaxed">
          Aktif dalam proses kreasi, penyebaran dan penerapan sains dan teknologi di bidang
          rekayasa perangkat lunak melalui layanan pendidikan tinggi vokasi dan penelitian
          terapan yang bermutu, terbuka, relevan, dan berkolaborasi erat dengan masyarakat
          dan industri dengan penerapan tata kelola institusi yang baik.
        </p>
  ...
  <section class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-[#065862] text-center">Profil Lulusan</h1>
    ...
    <div
      ...
      <div class="relative w-full h-full">
        ...
        <div
          class="slide absolute left-1/2 w-[90%] md:w-[700px] h-[380px] md:h-[300px] rounded-3xl bg-gradient-to-br from-[#006D8C] to-[#00F6CF] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-10 shadow-2xl transition-all duration-500">
          ...
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Software Developer</h1>
            <p class="text-[10px] md:text-sm mt-2 leading-relaxed">Seorang Software Developer adalah individu yang
              memiliki kemampuan dan keterampilan dalam menulis kode program komputer untuk solusi perangkat lunak.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Front-End Developer</h1>
            <p class="text-[10px] md:text-sm mt-2">Fokus pada pembuatan antarmuka pengguna yang interaktif dan menarik
              serta memastikan responsivitas desain.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Back-End Developer</h1>
            <p class="text-[10px] md:text-sm mt-2">Back-End Developer, sebaliknya, bertanggung jawab untuk pengembangan
              server, database, dan logika aplikasi yang tersembunyi dari pengguna. Mereka bekerja dengan bahasa
              pemrograman server-side seperti Java, Python, atau PHP. Keahlian dalam manajemen database dan keamanan
              sistem sangat diperlukan.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">IT Help Desk</h1>
            <p class="text-[10px] md:text-sm mt-2">Seorang profesional di IT Help Desk memiliki kemampuan untuk
              menangani permintaan dukungan teknis dari pengguna. Mereka berkomunikasi dengan jelas, dapat menganalisis
              masalah, dan memberikan solusi. Keahlian dalam troubleshooting dan pemecahan masalah menjadi kunci dalam
              peran ini.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">System Administrator</h1>
            <p class="text-[10px] md:text-sm mt-2">Sebuah pekerjaan yang memfokuskan diri untuk memperbaiki sebuah
              server baik itu instalasi sampai dengan masalah trobleshooting</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Desainer Web</h1>
            <p class="text-[10px] md:text-sm mt-2">Seorang System Administrator adalah individu yang mengelola dan
              memelihara infrastruktur IT perusahaan. Mereka merancang, mengimplementasikan, dan mengelola sistem serta
              jaringan. Keterampilan dalam manajemen server, keamanan informasi, dan penyelesaian masalah teknis sangat
              penting dalam peran ini.</p>
          </div>
        </div>
  ...
  <section id="kurikulum" class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-6 text-[#065862] text-center">
      Kurikulum
    </h1>
    ...
    <div class="w-full max-w-5xl mx-auto mt-4 p-4 md:p-6 flex flex-wrap">
      ...
      <label for="tab1" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C4EBED]
      font-bold cursor-pointer text-[#147F84]
      peer-checked/tab1:bg-[#86DADE] peer-checked/tab1:text-white
      rounded-t-xl text-sm md:text-base">
        Aktif
      </label>

      <div class="w-full px-4 md:px-10 py-10 md:py-20 bg-[#86DADE]
                      ...
                      <td class="border p-2">
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="flex items-center gap-2 border rounded-lg p-2">
                            <img src="{{ asset('images/file.png') }}" class="w-4 sm:w-5">
                            <div>
      ...
      <label for="tab2" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#C4EBED]
      font-bold cursor-pointer text-[#147F84]
      peer-checked/tab2:bg-[#86DADE] peer-checked/tab2:text-white
      rounded-t-xl text-sm md:text-base">
        Tidak Aktif
      </label>

      <div class="w-full p-4 md:p-12 bg-[#86DADE]
    ...
    rounded-lg shadow bg-white text-[#014B53]
                    ...
                    <table class="w-full text-xs border-collapse">
                      ...
                      <tbody>
                        <tr class="text-[10px] text-center">
                          ...
                          <td class="p-2 flex justify-center items-center">
                            <img src="{{ asset('images/silabus.png') }}" class="cursor-pointer" onclick="openModalSilabus()">
                          </td>
                        </tr>
                      </tbody>
          ...
          <div id="modalSilabus" class="fixed inset-0 hidden items-center justify-center bg-black/40 z-50">
            ...
            <div class="w-[800px] max-h-[90vh] bg-white rounded-2xl shadow-xl relative overflow-hidden">
              ...
              <div class="flex justify-center items-center py-3 relative">
                <h2 class="text-lg font-semibold text-[#1B4597]">Silabus</h2>

                <button onclick="closeModalSilabus()"
                  class="absolute right-4 w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center">
                  ✕
                </button>
              </div>
              ...
              <div class="p-5">
                <div class="overflow-y-auto max-h-[80vh]">
                  ...
                  <table class="w-full border border-gray-400 border-collapse text-sm">
                    ...
                    <tr>
                      <td class="border p-2 w-40">Mata Kuliah</td>
                      <td class="border p-2 w-10 text-center">:</td>
                      <td class="border p-2">Pemrograman Basis Data</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="border p-2">
                        ...
                        <div class="space-y-2">
                          ...
                          <div class="flex items-center gap-2 border rounded-lg p-2">
                            <img src="../foto/file.svg" class="w-5">
                            <div>
  ...
  <section id="dosen" class="max-w-4xl mx-auto py-10 flex flex-col items-center px-5">
    ...
    <!-- Title -->
    <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-12 text-[#065862] ">Dosen</h1>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(1)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-if1.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-teal-800">Yeni Rokhayati, S.Si., M.Sc</h2>
            <p class="text-gray-500">Kepala Program Studi Teknik Informatika</p>
          </div>
        </div>

        <span id="icon-1" class="text-teal-800 text-xl transition-transform duration-300"><img
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Email :</b> yeni@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-teal-800 mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Riau : Matematika</p>
              <p>Magister (S2) Universiti Malaysia Terengganu : Sains Matematik</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Data Science</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(2)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-if2.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-teal-800">Hilda Widyastuti, S.T., M.T.</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-2" class="text-teal-800 text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknik Informatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> hilda@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-teal-800 mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Bandung : Teknik Informatika</p>
              <p>Magister (S2) Institut Teknologi Bandung : Informatika</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Kecerdasan buatan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(3)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-if3.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-teal-800">Afdhol Dzikri, S.ST., M.T</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-3" class="text-teal-800 text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknik Informatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> afdhol@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-teal-800 mb-2">Riwayat Pendidikan</p>
              <p>Sarjana Terapan (DIV) PENS : Teknologi Informasi</p>
              <p>Magister (S2) Institut Teknologi Sepuluh Nopember : Jaringan Cerdas Multimedia, Teknik Elektro</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Computer Vision, Biometrik</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(4)">

        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-if4.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-teal-800">Condra Antoni,SS, M.A</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-4" class="text-teal-800 text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>

      <div id="content-4" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          <hr class="mb-4">
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknik Informatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> condra@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-teal-800 mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Universitas Andalas : Sastra Inggris</p>
              <p>Magister (S2) Radboud University : Linguistic</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Linguistic</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(5)">

        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-if5.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-teal-800">Mira Chandra Kirana, S.T., M.T</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-5" class="text-teal-800 text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>

      <div id="content-5" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          <hr class="mb-4">
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknik Informatika</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> mira@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-teal-800 mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Sepuluh Nopember : Teknik Elektro</p>
              <p>Magister (S2) Institut Teknologi Sepuluh Nopember : Teknik Elektro</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Biomedical Engineering, Image Processing, Intelligent System</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="kontak" class=" bg-cover bg-center bg-no-repeat text-white" style="background-image: url('{{ asset('images/footer-if.png') }}')">
    ...
    <!-- COPYRIGHT -->
    <div class="bg-gradient-to-r from-[#FE2574] to-[#F55A93] text-center text-sm py-2">
  ...
  <script>
    document.onclick = e => {
      ...
      document.querySelectorAll('.kur-btn')
        .forEach(b => {
          b.classList.remove('bg-gradient-to-b', 'from-[#014047]', 'to-[#029CAD]', 'text-white');
          b.classList.add('bg-white', 'text-[#014B53]');
        });

      // aktif gradient
      e.target.classList.remove('bg-white', 'text-[#014B53]');
      e.target.classList.add('bg-gradient-to-b', 'from-[#014047]', 'to-[#029CAD]', 'text-white');
    };

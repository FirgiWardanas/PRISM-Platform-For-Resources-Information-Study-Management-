...
<head>
  ...
  <title>halaman rekayasa keamanan siber</title>
...
<body class=" font-[Montserrat] ">
  <div class="min-h-screen w-full bg-cover bg-bottom bg-no-repeat text-white" style="background-image: url('{{ asset('images/bg-rks.png') }}')">
    <header class="w-full fixed z-100 bg-[#A1A1A1]">
      <nav class="flex justify-between items-center border-b-1 px-8 py-3">
        ...
        <div class="flex items-center gap-20">
          <ul class="hidden lg:flex gap-20 font-bold text-xs">
            <li>
              <a href="#home" class="hover:text-[#0685E6] transition duration-300 cursor-pointer">Beranda</a>
            </li>
            <li>
              <a href="#tentang" class="hover:text-[#0685E6] transition duration-300 cursor-pointer">Tentang Kami</a>
            </li>
            <li>
              <a href="#visimisi" class="hover:text-[#0685E6] transition duration-300 cursor-pointer">Visi Misi</a>
            </li>
            <li>
              <a href="#kurikulum" class="hover:text-[#0685E6] transition duration-300 cursor-pointer">Kurikulum</a>
            </li>
            <li>
              <a href="#dosen" class="hover:text-[#0685E6] transition duration-300 cursor-pointer">Dosen</a>
            </li>
          </ul>

          <div class="hidden lg:flex">
            <button
              class="bg-gradient-to-r from-[#0685E6] to-[#0AACF9] shadow-2xl px-8 py-2 rounded-lg text-primary text-xs font-bold hover:from-[#0368b5] hover:to-[#0484c0]hover:cursor-pointer hover:scale-105 transition">
              LOGIN
            </button>
          </div>
        </div>
      ...
      <div id="mobile-menu"
        ...
        <div class="flex flex-col gap-4 mt-4 px-2">
          <button
            class="bg-gradient-to-r from-[#0685E6] to-[#0AACF9] shadow-2xl px-8 py-3 rounded-lg text-white text-xs font-bold transition duration-200 hover:from-[#0368b5] hover:to-[#0484c0] hover:scale-102 hover:cursor-pointer">
            LOGIN
          </button>
        </div>
      </div>
    ...
    <section id="home"
      ...
      <div class="w-full max-w-6xl flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <!-- TEXT -->
        <div class="text-center md:text-left space-y-2 text-black">

          <img src="{{ asset('images/logo-rks.png') }}" class="w-24 sm:w-28 md:w-32 mx-auto md:mx-0">

          <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            Rekayasa Keamanan Siber
          </h1>

          <h3 class="text-sm sm:text-base md:text-lg lg:text-2xl text-gray-500 font-semibold">
            Program Studi Diploma 4
          </h3>

          <button class="bg-gradient-to-r from-[#0685E6] to-[#0AACF9] text-white
        ...
        <div class="flex justify-center">
          <img src="{{ asset('images/illustrasi-rks.png') }}" class="w-52 sm:w-64 md:w-88 sm:w-64 md:w-80 lg:w-[420px]
  ...
  ">
    <div class="flex flex-col justify-center items-center">
      <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-3 text-[#4F6374] text-center">Rekayasa Keamanan Siber</h1>
      <h1 class="text-2xl md:text-3xl font-semibold lg:text-4xl mb-3 text-[#AFC6D7]">Diploma 4</h1>
      <p class="text-center mb-12">Program studi yang mengkhususkan pada pengembangan keamanan siber untuk tujuan tertentu. Lulusan memiliki keterampilan yang baik di bidang keamanan siber dan jaringan.</p>
  ...
  <section id="visimisi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-40">
    ...
    <div class="absolute top-20 -left-20 w-80 z-0">
      <img src="{{ asset('images/ring-rks.png') }}" alt="">
    </div>
    ...
    <!-- TITLE -->
    <h1 class="text-3xl md:text-5xl font-bold text-[#4F6374] mb-16 text-center">
      Visi Misi
    </h1>
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6 z-10">
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 text-[#D9D9D9]">
          01
        </h1>

        <p class="font-bold text-[#4F6374] mb-3 text-lg md:text-xl">
          Visi Prodi RKS
        </p>

        <p class="text-sm md:text-base text-justify leading-relaxed">
          Menjadi program studi yang unggul dan berdaya saing dalam bidang Keamanan Siber di kawasan Asia Tenggara.
        </p>
      ...
      hover:scale-105 transition flex flex-col items-center">
        ...
        <p class="text-sm md:text-base text-justify leading-relaxed">
          Menyelenggarakan pendidikan vokasi dalam bidang Keamanan Siber terbaik di Asia Tenggara. Melakukan riset aplikatif berbasis kemitraan dengan industri dan masyarakat dibidang Keamanan Siber. Melakukan kegiatan pemberdayaan masyarakat di bidang Keamanan Siber. Menyelenggarakan tata kelola organisasi yang baik dan bersih.
        </p>
  ...
  <section class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-10 md:mb-16 text-[#4F6374] text-center">Profil Lulusan</h1>
    ...
    <div
      ...
      <div class="relative w-full h-full">
        ...
        <div
          class="slide absolute left-1/2 w-[90%] md:w-[700px] h-[380px] md:h-[300px] rounded-3xl bg-gradient-to-br from-[#5B829E] to-[#9DC5D8] flex flex-col md:flex-row items-center justify-center md:justify-start px-6 md:px-10 shadow-2xl transition-all duration-500">
          ...
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Cyber Security Analyst</h1>
            <p class="text-[10px] md:text-sm mt-2 leading-relaxed">Memiliki kemampuan dan keterampilan dalam menindaklanjuti ancaman keamanan dalam suatu organisasi, serta bertugas untuk melaksanakan prosedur-prosedur dan perintah dari pejabat diatasnya pada pusat operasi keamanan.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Cyber Security Administrator</h1>
            <p class="text-[10px] md:text-sm mt-2">Memiliki kemampuan dan keterampilan dalam melaksanakan implementasi dan membuat laporan pelaksanaan program keamanan siber sesuai rencana implementasi manajemen risiko yang sudah ditetapkan.</p>
          </div>
        </div>
        ...
        <div
          ...
          <img src="{{ asset('images/illustrasi programming.png') }}" class="w-32 md:w-56">
          <div class="text-white md:ml-6 text-center md:text-left mt-4 md:mt-0">
            <h1 class="text-2xl md:text-4xl font-bold">Network Security Administrator</h1>
            <p class="text-[10px] md:text-sm mt-2">Memiliki kemampuan dan keterampilan untuk menganalisa ancaman keamanan jaringan baik dari dalam maupun luar jangkauan dan mengembangkan kebijakan keamanan yang diperlukan sesuai kebijakan keamanan yang berlaku.</p>
          </div>
        </div>
  ...
  <section id="kurikulum" class="flex flex-col justify-center items-center mb-48 px-4">
    <h1 class="text-3xl md:text-5xl font-bold mb-6 text-[#4F6374] text-center">
      Kurikulum
    </h1>
    ...
    <div class="w-full max-w-5xl mx-auto mt-4 p-4 md:p-6 flex flex-wrap">
      ...
      <label for="tab1" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#CCD9E4]
      font-bold cursor-pointer text-[#5A6E7C]
      peer-checked/tab1:bg-[#9EB4C5] peer-checked/tab1:text-white
      rounded-t-xl text-sm md:text-base">
        Aktif
      </label>

      <div class="w-full px-4 md:px-10 py-10 md:py-20 bg-[#9EB4C5]
      ...
      <label for="tab2" class="w-1/2 md:w-40 h-12 md:h-14 flex items-center justify-center bg-[#CCD9E4]
      font-bold cursor-pointer text-[#5A6E7C]
      peer-checked/tab2:bg-[#9EB4C5] peer-checked/tab2:text-white
      rounded-t-xl text-sm md:text-base">
        Tidak Aktif
      </label>

      <div class="w-full p-4 md:p-12 bg-[#9EB4C5]
    ...
    rounded-lg shadow bg-white text-[#5A6E7C]
  ...
  <section id="dosen" class="max-w-4xl mx-auto py-10 flex flex-col items-center px-5">
    ...
    <!-- Title -->
    <h1 class="text-3xl md:text-5xl font-bold lg:text-5xl mb-12 text-[#4F6374] ">Dosen</h1>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(1)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-rks1.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#4F6374]">Maidel Fani, S.Pd., M.Kom.</h2>
            <p class="text-gray-500">Kepala Program Studi Rekayasa Keamanan Siber</p>
          </div>
        </div>

        <span id="icon-1" class="text-[#4F6374] text-xl transition-transform duration-300"><img
      ...
      <div id="content-1" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              <p><b>NIK :</b> 117192</p>
              <p><b>Program Studi :</b> Teknik Rekayasa Keamanan Siber</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> maidelfani@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#4F6374] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) STAIN Bukit tinggi : Pendidikan Teknik Informatika dan Komputer</p>
              <p>Magister (S2) Universitas Putra Indonesia Yptk Padang : Ilmu Komputer</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Ilmu Komputer</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(2)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-rks2.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#4F6374]">Hamdani Arif, S.Pd., M.Sc</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-2" class="text-[#4F6374] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
        ...
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              ...
              <p><b>Program Studi :</b> Teknik Rekayasa Keamanan Siber</p>
              <p><b>Pendidikan Terakhir :</b> Magister Strata 2 (S2)</p>
              <p><b>Email :</b> hamdaniarif@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#4F6374] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Univ. Negeri Malang : Teknik Informatika</p>
              <p>Magister (S2) Chang Gung University : Computer Science & Information Engineering</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Networking, IoT</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="w-full bg-white rounded-3xl shadow-md p-6 mb-6">
      <div class="flex items-center justify-between cursor-pointer" onclick="toggle(3)">
        ...
        <div class="flex items-center gap-4">
          <img src="{{ asset('images/dosen-rks3.png') }}" class="w-16 h-16 rounded-full">
          <div>
            <h2 class="text-xl font-bold text-[#4F6374]">Nur Cahyono Kushardianto,S.Si., M.T., M.Sc, Ph.D</h2>
            <p class="text-gray-500">Dosen</p>
          </div>
        </div>

        <span id="icon-3" class="text-[#4F6374] text-xl transition-transform duration-300"><img
            src="{{ asset('images/panah.png') }}" class="w-10"></span>
      </div>
      ...
      <div id="content-3" class="overflow-hidden max-h-0 transition-all duration-500 ease-in-out">
        <div class="mt-4">
          ...
          <div class="grid md:grid-cols-2 gap-4 text-gray-700">
            <div>
              <p><b>NIK :</b> 106044</p>
              <p><b>Program Studi :</b> Teknologi Rekayasa Perangkat Lunak</p>
              <p><b>Pendidikan Terakhir :</b>  Doktoral Strata 3 (S3)</p>
              <p><b>Email :</b>  anung@polibatam.ac.id</p>
            </div>
            <div>
              <p class="font-bold text-[#4F6374] mb-2">Riwayat Pendidikan</p>
              <p>Sarjana (S1) Institut Teknologi Bandung : Matematika</p>
              <p>Magister (S2) Universitas Indonesia : Jaringan Informasi dan Multimedia</p>
              <p>Magister (S2) Université de Valenciennes et du Hainaut-Cambrésis : Teknik Sistem Komunikasi</p>
              <p>Doktor (S3) Universite Polytechnique Hauts-de-France : Electronics</p>
              <p class="mt-2"><b>Bidang Spesialis :</b> Jaringan Komputer, Teknologi Komunikasi, dan Machine Learning</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="kontak" class=" bg-cover bg-center bg-no-repeat text-white" style="background-image: url('{{ asset('images/footer-rks.png') }}')">
    ...
    <!-- COPYRIGHT -->
    <div class="bg-gradient-to-r from-[#0688E7] to-[#09A9F7] text-center text-sm py-2">
  ...
  <script>
    document.onclick = e => {
      ...
      document.querySelectorAll('.kur-btn')
        .forEach(b => {
          b.classList.remove('bg-gradient-to-b', 'from-[#5B829E]', 'to-[#9DC5D8]', 'text-white');
          b.classList.add('bg-white', 'text-[#5A6E7C]');
        });

      // aktif gradient
      e.target.classList.remove('bg-white', 'text-[#5A6E7C]');
      e.target.classList.add('bg-gradient-to-b', 'from-[#5B829E]', 'to-[#9DC5D8]', 'text-white');
    };

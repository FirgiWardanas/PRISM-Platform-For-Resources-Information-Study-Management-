  ...
  <body class="font-[Montserrat]">
    ...
    <section id="programStudi" class="py-20 relative overflow-hidden flex flex-col justify-center items-center mb-60">
      ...
      <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 px-6">
        ...
        <!-- 1 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition  bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-if.png') }}')">
          <h1 class="text-[#00766D] font-bold text-xl">Teknik Informatika</h1>
          <p class=" font-semibold text-[#00766D] mb-3">Diploma 3</p>

          <img src="{{ asset('images/logo-if.png') }}" class="w-20 md:w-28">
        ...
        <!-- 2 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-gm.png') }}')">
          <h1 class="text-[#589230] font-bold text-xl">Teknologi Geomatika</h1>
          <p class=" font-semibold text-[#589230] mb-3">Diploma 3</p>

          <img src="{{ asset('images/logo-gm.png') }}" class="w-20 md:w-28">
        ...
        <!-- 3 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-an.png') }}')">
          <h1 class="text-[#B60019] font-bold text-xl">Animasi</h1>
          <p class=" font-semibold text-[#B60019] mb-3">Sarjana Terapan</p>

          <img src="{{ asset('images/logo-an.png') }}" class="w-20 md:w-28">
        ...
        <!-- 4 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition  bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-trm.png') }}')">
          ...
          <img src="{{ asset('images/logo-trm.png') }}" class="w-20 md:w-28">
        ...
        <!-- 5 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition  bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-rks.png') }}')">
          ...
          <img src="{{ asset('images/logo-rks.png') }}" class="w-20 md:w-28">
        ...
        <!-- 6 -->
        <div
          class="w-[250px] sm:w-full mx-auto relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition  bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-trpl.png') }}')">
          ...
          <img src="{{ asset('images/logo-trpl.png') }}" class="w-20 md:w-28">
        ...
        <div
          class="w-[250px] sm:w-full mx-auto md:col-start-2 relative bg-white rounded-2xl shadow-md p-4 md:p-6 text-center overflow-hidden hover:scale-105 transition  bg-cover bg-center bg-no-repeat flex flex-col items-center" style="background-image: url('{{ asset('images/card-tp.png') }}')">
          <h1 class="text-[#462471] font-bold text-xl">Teknologi Permainan</h1>
          <p class=" font-semibold text-[#462471] mb-3">Sarjana Terapan</p>

          <img src="{{ asset('images/logo-tp.png') }}" class="w-20 md:w-28">
